namespace PicasaUpload
{
	partial class PicasaPubliserForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.picasaFeedBindingSource = new System.Windows.Forms.BindingSource(this.components);
			...
			((System.ComponentModel.ISupportInitialize)(this.picasaFeedBindingSource)).BeginInit();
			this.SuspendLayout();
			// 
			// _cmdLogin
			// 
			...
			// comboBox1
			// 
			this.comboBox1.DataSource = this.entriesBindingSource;
			this.comboBox1.DisplayMember = "Title";
			this.comboBox1.FormattingEnabled = true;
			this.comboBox1.Location = new System.Drawing.Point(74, 114);
			...
			this.entriesBindingSource.DataSource = this.picasaFeedBindingSource;
			// 
			// picasaFeedBindingSource
			// 
			this.picasaFeedBindingSource.DataSource = typeof(Google.GData.Photos.PicasaFeed);
			// 
			// PicasaPubliserForm
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.picasaFeedBindingSource)).EndInit();
		...
		private System.Windows.Forms.BindingSource picasaFeedBindingSource;
