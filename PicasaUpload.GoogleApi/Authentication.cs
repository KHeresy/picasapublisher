...
namespace PicasaUpload.GoogleApi
{
	...
	internal class Authentication
	{
		...
		public static AuthenticationResult Authenticate(AccountTypes accountType, string email, string password, Services service, string applicationSource, string loginToken, string logincaptcha)
		{
			...
			postData.AppendFormat(postDataFormat, "accountType", HttpUtility.UrlPathEncode(accountType.ToString()));
			postData.AppendFormat(postDataFormat, "Email", HttpUtility.UrlPathEncode(email));
			postData.AppendFormat(postDataFormat, "Passwd", HttpUtility.UrlPathEncode(password));
			postData.AppendFormat(postDataFormat, "service", HttpUtility.UrlPathEncode(GetServiceName(service)));
			postData.AppendFormat(postDataFormat, "source", HttpUtility.UrlPathEncode(applicationSource));
